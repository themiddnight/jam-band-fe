...
export const loadGuitarAudioSample = async (samplePath: string): Promise<AudioBuffer> => {
  try {
...
export const playStrumEffect = async (
  ...
  console.log(`Strumming ${notes.length} notes ${direction} at ${speed}ms intervals`);
