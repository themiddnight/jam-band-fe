...
export const getChordFromDegree = (
  ...
  if (modifiers.has("dominant7")) {
    ...
    const highestNoteIndex = getNoteIndex(
      finalChordNotes[finalChordNotes.length - 1],
    );
...
export const getChordName = (
  ...
  const qualities =
    scale === "major" ? MAJOR_CHORD_QUALITIES : MINOR_CHORD_QUALITIES;
