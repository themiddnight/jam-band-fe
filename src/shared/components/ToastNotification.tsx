...
import { toastManager, type ToastMessage, type ToastMessageInput } from '@/shared/hooks/useToastNotification';

export type { ToastMessage, ToastMessageInput } from '@/shared/hooks/useToastNotification';
